            ...
            <>
                ...
                <div className="content">
                    <form>
                        ...
                        <div>
                            <div className={passwordLength ? 'textStrongOk' : 'textStrong'}>Contains More than 8 characters</div>
                            <div className={containsNumbers ? 'textStrongOk' : 'textStrong'}>Contains numbers</div>
                            <div className={isUpperCase ? 'textStrongOk' : 'textStrong'}>Contains UpperCase</div>
                            <div className={containsSymbols ? 'textStrongOk' : 'textStrong'}>Contains Symbols</div>
                        </div>
